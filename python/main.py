...
i = 1
j = 1
total = len(os.listdir("./dataset/images")) * \
    len(os.listdir("./dataset/crops"))

for template_image in os.listdir("./dataset/crops"):
    added = False
    for main_image in os.listdir("./dataset/images"):
        img2 = cv.imread('./dataset/images/' + main_image)
        img1 = cv.imread('./dataset/crops/' + template_image)
